...
- [ ] 15-07-PLAN.md — sweep_tripadvisor bulk national branch + resume + fail-fast progress + operator slice trigger
- [ ] 15-08-PLAN.md — Dashboard live sweep progress panel (mirror EngineControl; MSW + Vitest)
