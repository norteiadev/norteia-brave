...
| 260923-nrx | Deepen Mar publication: one module (brave/core/mar/publication.py: promote / publish / republish_pending) owns audit+commit+enqueue; single brave.publish_mar task replaces the 3 push tasks; norteia-api adapters push(entity_type, payload)->bool + ApiDown; no 503 on broker-down (outbox recovers); CONTEXT.md glossary | 2026-09-23 | fd643b8 | ✅ | [260923-nrx-deepen-mar-publication-module](./quick/260923-nrx-deepen-mar-publication-module/) |
