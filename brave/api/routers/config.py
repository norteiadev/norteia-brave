...
def _current_value(cfg: AppConfig, dotted: str) -> Any:
    ...
    if dotted == _DESC_CASCADE_KEY:
        return cfg.atrativo_description_cascade_enabled
...
def _validate_updates(db: Session, updates: dict[str, Any]) -> None:
    ...
    for key, value in updates.items():
        ...
        elif key in (_DESC_ENRICH_KEY, _PLACES_ENRICH_KEY, _DESC_BATCH_KEY, _DESC_CASCADE_KEY):
