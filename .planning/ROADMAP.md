...
Plans:
- [ ] 17-01-PLAN.md — Scoped light tokens + single-shell (sidebar/topbar/view-switcher) at /painel; topbar wired to engine-api (motor switch, TA pill, source) [wave 1]
- [ ] 17-02-PLAN.md — Painel data layer: unified PainelCard model + pure selectors (columns/metrics/filter) + usePainelBoard hook over destinos/atrativos lists [wave 1]
