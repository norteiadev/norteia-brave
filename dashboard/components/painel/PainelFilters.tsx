...
/**
 * The Painel header's filter control — a presentational, fully controlled
 * UF-scope dropdown that SINGLE-selects one of the 27 BR UFs (click to pick,
 * click again or "Todas" to clear to null) — one state at a time so the whole
 * board scopes to that UF ("acompanhar o processo por UF").
 *
